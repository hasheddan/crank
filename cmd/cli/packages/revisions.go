...
// revisions will list revisions for a package.
var revisions = &cobra.Command{
	Use:   "revisions",
	Short: "List all revisions for an installed package.",
	Long:  ``,
	Run: func(cmd *cobra.Command, args []string) {
		...
		prs := &v1alpha1.PackageRevisionList{}
